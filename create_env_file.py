...
def validate_input(value: str, var_info: Dict[str, Any]) -> Tuple[bool, str]:
    ...
    if "pattern" in var_info and var_info["pattern"]:
...
def get_input_with_validation(var_info: Dict[str, Any], current_value: Optional[str] = None) -> str:
    """
    ...
    default_display = f" [По умолчанию: {var_info.get('default', '')}]" if "default" in var_info else ""
