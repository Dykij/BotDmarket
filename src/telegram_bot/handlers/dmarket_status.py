...
async def dmarket_status_impl(update: Update, context: CallbackContext, status_message=None) -> None:
    """
    ...
    try:
        ...
        try:
            ...
            api_status = f"❌ <b>Ошибка соединения</b>: {str(e)}"
            balance_info = "<i>Не удалось проверить баланс.</i>"
