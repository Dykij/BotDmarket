...
async def arbitrage_callback_impl(update: Update, context: CallbackContext) -> Optional[int]:
    """
...
async def handle_dmarket_arbitrage_impl(query: CallbackQuery, context: CallbackContext, mode: str) -> None:
    """
...
async def handle_game_selection_impl(query: CallbackQuery, context: CallbackContext) -> Optional[int]:
    """
...
async def handle_game_selected_impl(query: CallbackQuery, context: CallbackContext, game: str) -> Optional[int]:
    """
