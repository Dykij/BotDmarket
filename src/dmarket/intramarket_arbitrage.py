...
async def find_price_anomalies(
    ...
    try:
        ...
        logger.error(f"Error in find_price_anomalies: {e!s}")
        return []
    finally:
...
async def find_trending_items(
    ...
    try:
        ...
        logger.error(f"Error in find_trending_items: {e!s}")
        return []
    finally:
        if close_api and hasattr(dmarket_api, "_close_client"):
            await dmarket_api._close_client()
...
async def find_mispriced_rare_items(
    ...
    try:
        ...
        logger.error(f"Error in find_mispriced_rare_items: {e!s}")
        return []
    finally:
        if close_api and hasattr(dmarket_api, "_close_client"):
            await dmarket_api._close_client()
    ...
    try:
        ...
        for category, game, task_coroutine in tasks:
            try:
                ...
                logger.error(f"Error in {category} scan for {game}: {e!s}")
                if category == "anomalies":
        ...
        logger.error(f"Error in scan_for_intramarket_opportunities: {e!s}")
        return {
