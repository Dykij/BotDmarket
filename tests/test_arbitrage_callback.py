...
@pytest.mark.asyncio
@patch("src.telegram_bot.bot_v2.handle_best_opportunities")
async def test_arbitrage_callback_best_opportunities(mock_handle_best_opportunities, mock_query, mock_context):
