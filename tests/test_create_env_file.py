...
class TestCreateEnvFile(unittest.TestCase):
    ...
    def test_read_existing_env(self, mock_exists, mock_file):
        ...
        # Check result
        self.assertEqual(result["TELEGRAM_BOT_TOKEN"], "1234567890:AABBCCDDEEFFGGHHIIJJKKLLMMNNOOPPQQ")
    ...
    def test_validate_input_valid(self):
        ...
        is_valid, _ = create_env_file.validate_input("1234567890:AABBCCDDEEFFGGHHIIJJKKLLMMNNOOPPQQ", var_info)
    ...
    def test_validate_input_invalid(self):
        ...
        self.assertFalse(is_valid)
        self.assertEqual(error_message, "Токен должен иметь формат '123456789:AABBCCDDEEFFGGHHIIJJKKLLMMNNOOPPабвг'")
